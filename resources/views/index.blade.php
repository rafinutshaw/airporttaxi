        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 single-gallery">
                    <a href="img/g1.jpg" class="img-gal"><img class="img-fluid" src="{{ asset("img/g1.jpg") }}" alt=""></a>
                    <a href="img/g4.jpg" class="img-gal"><img class="img-fluid" src="{{ asset("img/g4.jpg") }}" alt=""></a>
                </div>
                <div class="col-lg-4 single-gallery">
                    <a href="img/g2.jpg" class="img-gal"><img class="img-fluid" src="{{ asset("img/g2.jpg") }}" alt=""></a>
                    <a href="img/g5.jpg" class="img-gal"><img class="img-fluid" src="{{ asset("img/g5.jpg") }}" alt=""></a>
                </div>
                <div class="col-lg-4 single-gallery">
                    <a href="img/g3.jpg" class="img-gal"><img class="img-fluid" src="{{ asset("img/g3.jpg") }}" alt=""></a>
                    <a href="img/g6.jpg" class="img-gal"><img class="img-fluid" src="{{ asset("img/g6.jpg") }}" alt=""></a>
                </div>
            </div>
        </div>
    </section>
